<!-- ========================================================================= -->
<!--                   ❖ SYSTEM BOOT & CYBERNETIC HUD ❖                        -->
<!-- ========================================================================= -->

<div align="center">

<!-- TOP CYBER WAVE BANNER -->
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:000000,30:050b14,70:00d9ff,100:b000ff&height=180&section=header&text=PHANYAWAT%20WANMARAT&fontColor=ffffff&fontSize=42&fontAlignY=35&desc=%E2%9D%96%20ROS%20ENGINEER%20%E2%80%A2%20ROBOTICS%20DEVELOPER%20%E2%80%A2%20COMPETITIVE%20PROGRAMMER%20%E2%9D%96&descAlignY=65&descSize=16" width="100%" />
...
<!-- CYBER STATUS HUD BADGES -->
<p align="center">
  <img src="https://img.shields.io/badge/CORE_STATUS-ONLINE-00FF66?style=for-the-badge&logo=opsgenie&logoColor=black&labelColor=0D1117" />
  <img src="https://img.shields.io/badge/SECURITY_CLEARANCE-LEVEL_7-00D9FF?style=for-the-badge&logo=matrix&logoColor=00D9FF&labelColor=0D1117" />
  <img src="https://img.shields.io/badge/PRIMARY_CORE-ROS2_HUMBLE-22314E?style=for-the-badge&logo=ros&logoColor=white&labelColor=0D1117" />
  <img src="https://img.shields.io/badge/UI_MATRIX-REACT_19-61DAFB?style=for-the-badge&logo=react&logoColor=61DAFB&labelColor=0D1117" />
  <img src="https://img.shields.io/badge/THREAT_LEVEL-OVERPOWERED-B000FF?style=for-the-badge&logo=hackthebox&logoColor=B000FF&labelColor=0D1117" />
</p>
...
### `> ./sys/core/terminal_exec.sh --verbose`

<details open>
<summary><b><kbd> 📁 /root/operator_manifest.json &nbsp; ↲ </kbd></b></summary>
<br>
...
<img src="https://media.giphy.com/media/LmNwrBhejkK9EFP504/giphy.gif" width="100%" style="border-radius: 10px; border: 2px solid #00D9FF; box-shadow: 0 0 15px #00D9FF;" />

<br><br>

<img src="https://media.giphy.com/media/VbVKjj1hXf2eQO4O6p/giphy.gif" width="100%" style="border-radius: 10px; border: 2px solid #b000ff; box-shadow: 0 0 15px #b000ff;" />
...
```json
{
  ...
  "NEURAL_CAPABILITIES": {
    "robotics_brain": [
      ...
      "Kinematics & Micro-Mouse Algorithms"
    ],
    "hardware_embedded": [
      "ROS1 / ROS2 (Humble/Foxy)",
      "ESP32 / STM32 / Arduino",
      "Raspberry Pi / Jetson Nano",
      "CAN Bus / Serial Protocols"
    ],
    "cyber_software": [
      "C++20 / Python 3.12 / TypeScript",
      "React 19 / Vite / Tailwind CSS",
      "Docker / Linux Kernel / Bash Shell",
      "Git / CI/CD Pipelines"
    ]
  },

  "SYSTEM_AFFILIATION": [
    "SPR Picture Team Lead",
    "Kasetsart University Robotics Contender",
    "Thailand Cyber Top Talent Finalist"
  ]
}
```
...
### `> ./modules/tech_armory.sh --display=icons`
...
<img src="https://skillicons.dev/icons?i=ros,cpp,python,c,arduino,raspberrypi,linux,bash&theme=dark&perline=4" />
</a>
...
[ ARDUINO ]   [ R-PI ]  [ LINUX ]  [ BASH SHELL ]
```

</td>
<td width="50%" align="center">

<b><code>// 🌐 WEB INTERFACES & DEPLOYMENT //</code></b>

<br><br>

<a href="https://skillicons.dev">
<img src="https://skillicons.dev/icons?i=react,ts,js,tailwind,vite,nextjs,nodejs,docker,git,github,vscode,figma&theme=dark&perline=6" />
</a>
...
### `> cat /var/log/active_operations.log`

<div align="center">

| 🛰️ **OPERATION ID** | ⚡ **MISSION BRIEF & ARCHITECTURE** | 🛠️ **TECH STACK** | 📊 **STATUS** |
| :--- | :--- | :--- | :---: |
| **`autonomous-guest-bot`** | Autonomous mobile service robot powered by **ROS Nav2** & Computer Vision for guest detection & interaction. | `<ROS2>` `<Python>` `<YOLO>` `<OpenCV>` | `🟢 ACTIVE` |
| **`smart-cane-esp32`** | Smart assistive cane for visually impaired with ESP32 IoT, GPS tracking & automated LINE notify alerts. | `<ESP32>` `<C++>` `<IoT>` `<GPS>` | `🟢 ACTIVE` |
| **`sprpic-platform`** | High-performance 3D interactive web showcase for SPR Picture built with modern web technologies. | `<React 19>` `<Three.js>` `<GSAP>` | `⚡ DEPLOYED` |

</div>

---

### `> cat /var/log/hall_of_fame.log`

<div align="center">

```text
╔═════════════════════════════════════════════════════════════════════════════════════════════════╗
║                               🏆 HONORS & COMPETITION ACHIEVEMENTS 🏆                           ║
╠═════════════════════════════════════════════════════════════════════════════════════════════════╣
║                                                                                                 ║
║  [S-RANK] 🛡️ Thailand Cyber Top Talent 2026                                                      ║
║           └─ Top 10 Finalist • 5th Place Overall • Honorable Mention (out of 383 teams) • ฿3,000  ║
║                                                                                                 ║
║  [A-RANK] 🤖 @Home Robot Open-Platform Education League 2026                                    ║
║           └─ 2nd Runner-up • 4th Place Overall National Level                                   ║
║                                                                                                 ║
║  [S-RANK] 🥇 CEMIP Open House 2025                                                              ║
║           └─ Gold Medal (1st Place Central Region) & Gold Medal (National Level)               ║
║                                                                                                 ║
║  [A-RANK] 🦾 SIITec AI & Robot Arm Hackathon                                                    ║
║           └─ Silver Medalist • Prize: ฿3,000                                                    ║
║                                                                                                 ║
║  [A-RANK] 🧠 iDekTep Mini Coding (Python for AI) Challenge 2025                                 ║
║           └─ 1st Place Honorable Mention                                                        ║
║                                                                                                 ║
║  [B-RANK] 🏎️ iDektep Robot Challenge @ Kaset Fair 2026                                           ║
║           └─ 6th Place (out of 63 competing teams)                                              ║
║                                                                                                 ║
║  [A-RANK] 🐭 NSTDA Micro-Mouse Contest 2027                                                     ║
║           └─ Qualified for Central Region Final Round                                           ║
║                                                                                                 ║
║  [B-RANK] 🤖 @Home Robot Education 2025                                                         ║
║           └─ Advanced to National Final Round                                                   ║
║                                                                                                 ║
╚═════════════════════════════════════════════════════════════════════════════════════════════════╝
```
...
### `> ./security/cyber_top_talent_2026.sh --decrypt`

<div align="center">

<img src="https://readme-typing-svg.herokuapp.com?font=Share+Tech+Mono&weight=700&size=24&duration=3000&pause=700&color=b000ff&center=true&vCenter=true&width=850&height=45&lines=>>+CRITICAL+ACHIEVEMENT+UNLOCKED...;>>+CYBER+TOP+TALENT+2026+FINALIST...;>>+ROYAL+TROPHY+COMPETITION+HONOR..." />
...
╠══════════════════════════════════════════════════════════════════════════════════╣
║                                                                                  ║
║  👑 ROYAL HONOR : ชิงถ้วยพระราชทานสมเด็จพระบรมราชินี                                 ║
║  🎯 EVENT       : Thailand Cyber Top Talent 2026 (National CTF)                  ║
║  🏆 STATUS      : TOP 10 FINALIST (5TH PLACE OVERALL)                            ║
║  ⚔️ FIELD       : 383 COMPETITOR TEAMS NATIONWIDE                                ║
║  🎖️ AWARD       : HONORABLE MENTION CERTIFICATE                                  ║
║  💰 BOUNTY      : ฿3,000 PRIZE POOL                                              ║
║                                                                                  ║
║  [████████████████████████████████████████████████████████████████████████████]  ║
║  >>> SECURITY CLEARANCE ELEVATED TO TOP 5 CYBER COMPETITOR IN THAILAND <<<       ║
║  [████████████████████████████████████████████████████████████████████████████]  ║
║                                                                                  ║
╚══════════════════════════════════════════════════════════════════════════════════╝
```
...
<b><code>[ NODE 01: PERSONAL PORTFOLIO ]</code></b>

<br>

<i>Interactive Developer Showcase</i>
...
<b><code>[ NODE 02: TEAM SPRPICTURE ]</code></b>

<br>

<i>Official Team Platform</i>
...
<img src="https://readme-typing-svg.herokuapp.com?font=Share+Tech+Mono&weight=700&size=20&duration=3000&pause=500&color=00D9FF&center=true&vCenter=true&width=800&height=30&lines=>>+TRANSMITTING+SIGNAL+TO+NET...;>>+AWAITING+INCOMING+TRANSMISSION..." />
