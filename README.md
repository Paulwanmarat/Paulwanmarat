...
<img height="160" src="https://github-readme-stats.vercel.app/api?username=YOUR_USERNAME&show_icons=true&theme=tokyonight&hide_border=true&bg_color=0D1117&title_color=00D9FF&icon_color=00D9FF&text_color=FFFFFF" />
...
I believe the best way to learn engineering is to build things that actually work —  
robots that navigate real rooms, code that runs on real hardware, systems that fail  
and teach you why. Every bug is a lesson. Every sensor glitch is a puzzle.
...
```
╔══════════════════════════════════════════╗
║   Building the future, one robot at      ║
║   a time — from Bangkok to Kasetsart.    ║
╚══════════════════════════════════════════╝
```
